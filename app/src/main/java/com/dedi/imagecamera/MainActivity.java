...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btn_gambar_lain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_gambar_lain= (Button) findViewById(R.id.btn_gambar_lain);
        btn_ambil_gambar=(Button) findViewById(R.id.btn_ambil_gambar);
        img_view = (ImageView) findViewById(R.id.img_view);

        btn_gambar_lain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, FotoLain.class);
